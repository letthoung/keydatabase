...
function FullScreenControl(map, enterFull, exitFull) {
    ...
    google.maps.event.addDomListener(controlUI, "click", function () {
        if (!fullScreen) {
			...
			$("#container").attr("class", "calf");
			$("#containall").attr("class", "conf");
			$("#menuholder").attr("class", "mnf");
			$("#iframeholder").attr("class", "ifrf");
			$("#mButton").toggle();
			$("#IFButton").toggle();			
			$("#cButton").toggle();			
        }
			...
			$("#container").attr("class", "cal");
			$("#containall").attr("class", "con");
			$("#menuholder").attr("class", "mn");
			$("#iframeholder").attr("class", "ifr");
			$("#container").show();
			$("#menuholder").show();
			$("#iframeholder").show();
			$("#mButton").toggle();
