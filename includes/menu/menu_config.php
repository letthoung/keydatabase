...
$menuExtras[4] =   array ( 'menu', 'External Tools', '',
  array (
    array ( 'item', 'map.png', 'Quick Measure', '6.3address.php', ''),
	 array ( 'item', 'map.png', 'PushPin', 'map.php', ''),
   
	 array ( 'item', 'asset.png', 'Database', 'assethome.php', ''),
	  array ( 'item', 'qrgen.png', 'QR Generator', 'http://www.ezdashboard.com/qrgen/', ''),
	  
   )
);
$menuExtras[100] =   array ( 'item', 'button23975933.png', '', 'back.php'
